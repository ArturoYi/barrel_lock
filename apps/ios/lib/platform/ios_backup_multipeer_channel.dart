...
/// iOS MultipeerConnectivity MethodChannel 封装。
abstract final class IosBackupMultipeerChannel {
  static const _channel = MethodChannel('com.barrellock/backup_multipeer');
