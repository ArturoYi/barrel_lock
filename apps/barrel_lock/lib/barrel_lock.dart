...
export 'features/attachment_manage/attachment_manage.dart';
export 'features/backup_manage/backup_manage.dart';
export 'features/cipher_add/cipher_add.dart';
export 'features/folder_manage/folder_manage.dart';
export 'features/vault_manage/vault_manage.dart';
export 'features/data_migration/data_migration.dart';
export 'features/detail/detail.dart';
export 'features/home/home.dart';
export 'features/language_settings/language_settings.dart';
...
export 'l10n/barrel_lock_l10n.dart';
export 'l10n/overlay_l10n.dart';
